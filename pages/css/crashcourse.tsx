  ...
  const data = [
    {
      ...
      description: `In this video you will be learning the fundamentals of CSS by going through the exact same world class crash course David completed on his journey to top tech.
